...
describe('parse.lua', function()
  ...
  describe('git_repo_root_dir', function()
    it('with newline', function()
      local input = '/home/john/code/my-amazing-project\n'
      local git_repo_root_dir = parse.git_repo_root_dir(input)
      assert.equal('/home/john/code/my-amazing-project', git_repo_root_dir)
    end)
